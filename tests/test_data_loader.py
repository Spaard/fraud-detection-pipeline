import pytest
import pandas as pd
from src.data_loader import load_transaction_data, filter_by_amount, calculate_fraud_metrics
...
def sample_data():
    ...
    return pd.DataFrame({
        ...
        'time_settled': ['2022-01-01 10:00:00', '2022-01-01 11:00:00', '2022-01-01 12:00:00', '2022-01-01 13:00:00'],
...
def test_load_transaction_data_file_not_found():
    ...
    with pytest.raises(FileNotFoundError):
        load_transaction_data("invalid/path/file.csv")

def test_load_transaction_data_datetime_parsing(tmp_path):
    """Verify 'time_settled' is converted to datetime type upon loading."""
    csv_file = tmp_path / "dummy.csv"
    csv_file.write_text("time_settled,movement_amount_euros,is_fraud\n2022-01-01 10:00:00,10.0,0")
    
    df = load_transaction_data(str(csv_file))
